...
load("13 07 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "14 01 Cflux sens-1"
...
load("14 01 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "14 01 Cflux sens-2"
...
load("14 01 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "14 02 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("14 02 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "14 02 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("14 02 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "14 03 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("14 03 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "14 03 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
