...
load("00g SS-3 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "15 01 Cflux sens-1"
...
load("15 01 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "15 01 Cflux sens-2"
...
load("15 01 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "15 02 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("15 02 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "15 02 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("15 02 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "15 03 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("15 03 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "15 03 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("15 03 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "15 04 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("15 04 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "15 04 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("15 04 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "15 05 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("15 05 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "15 05 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("15 05 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "15 06 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("15 06 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "15 06 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("15 06 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "15 07 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("15 07 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "15 07 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("15 07 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "15 08 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("15 08 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "15 08 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("15 08 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "15 09 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("15 09 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "15 09 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("15 09 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "15 10 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("15 10 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "15 10 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
