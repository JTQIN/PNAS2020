...
load("07 17 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "08 01 Cflux sens-1"
...
load("08 01 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "08 01 Cflux sens-2"
...
load("08 01 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "08 02 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("08 02 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "08 02 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("08 02 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "08 03 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("08 03 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "08 03 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("08 03 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "08 04 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("08 04 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "08 04 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("08 04 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "08 05 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("08 05 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "08 05 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("08 05 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "08 06 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("08 06 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "08 06 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("08 06 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "08 07 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("08 07 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "08 07 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("08 07 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "08 08 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("08 08 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "08 08 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
