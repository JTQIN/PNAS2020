...
load("15 10 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "16 01 Cflux sens-1"
...
load("16 01 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "16 01 Cflux sens-2"
...
load("16 01 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "16 02 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("16 02 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "16 02 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("16 02 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "16 03 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("16 03 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "16 03 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("16 03 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "16 04 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("16 04 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "16 04 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
