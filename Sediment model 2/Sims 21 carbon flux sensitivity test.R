...
load("00j SS-3 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "21 01 Cflux sens-1"
...
load("21 01 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "21 01 Cflux sens-2"
...
load("21 01 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "21 02 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("21 02 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "21 02 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("21 02 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "21 03 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("21 03 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "21 03 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("21 03 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "21 04 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("21 04 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "21 04 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("21 04 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "21 05 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("21 05 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "21 05 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("21 05 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "21 06 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("21 06 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "21 06 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("21 06 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "21 07 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("21 07 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "21 07 Cflux sens-2"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("21 07 Cflux sens-2 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "21 07 Cflux sens-3"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
sim.info$index <- "21 08 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
#=============================================================================
# Z = 550 m - 2 STILL TO DO
#=============================================================================

load("21 08 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "210 08 Cflux sens-2"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
#=============================================================================
# Z = 550 m - 3 STILL TO DO
#=============================================================================

load("20 08 Cflux sens-2 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "20 08 Cflux sens-3"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
#=============================================================================
# Z = 550 m - 4 STILL TO DO
#=============================================================================

load("20 08 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "20 08 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
