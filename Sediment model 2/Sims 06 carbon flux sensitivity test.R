...
load("05 18 Cflux sens-3 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "06 01 Cflux sens-1"
...
load("06 01 Cflux sens-1 Transient.Rdata")
...
load("06 01 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "06 02 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("06 02 Cflux sens-1 Transient.Rdata")
...
load("06 02 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "06 03 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("06 03 Cflux sens-1 Transient.Rdata")
...
load("06 03 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "06 04 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("06 04 Cflux sens-1 Transient.Rdata")
...
load("06 04 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "06 05 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
Z <- 1
PL$F.OC <- (10^(-0.50860503 - 0.00038900*Z)*1.8*1000)*1.15
...
load("06 05 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "06 05 Cflux sens-2"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("06 05 Cflux sens-2 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "06 05 Cflux sens-3"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("06 05 Cflux sens-3 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "06 05 Cflux sens-4"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("06 05 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "06 06 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("06 06 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "06 06 Cflux sens-2"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("06 06 Cflux sens-2 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "06 06 Cflux sens-3"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("06 06 Cflux sens-3 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "06 06 Cflux sens-4"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
