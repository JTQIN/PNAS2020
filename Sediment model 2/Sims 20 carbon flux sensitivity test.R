...
load("00i SS-3 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "20 01 Cflux sens-1"
...
load("20 01 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "20 01 Cflux sens-2"
...
load("20 01 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "20 02 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("20 02 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "20 02 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("20 02 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "20 03 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("20 03 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "20 03 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("20 03 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "20 04 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("20 04 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "20 04 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("20 04 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "20 05 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("20 05 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "20 05 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("20 05 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "20 06 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("20 06 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "20 06 Cflux sens-2"
sim.info$code <- "Steady"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("20 06 Cflux sens-2 Steady.Rdata")

# Initialisation simulation type 

sim.info$index <- "20 07 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("20 07 Cflux sens-1 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "20 07 Cflux sens-2"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("20 07 Cflux sens-2 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "20 07 Cflux sens-3"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
load("20 07 Cflux sens-3 Transient.Rdata")

# Initialisation simulation type 

sim.info$index <- "20 07 Cflux sens-4"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
...
sim.info$index <- "20 08 Cflux sens-1"
sim.info$code <- "Transient"
sim.info$name <- paste(sim.info$index,sim.info$code)
