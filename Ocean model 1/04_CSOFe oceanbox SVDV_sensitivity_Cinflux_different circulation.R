...
load("00e_CSOFe_runsteady.Rdata")
...
PP.frac <- c(seq(1,0.75,-0.01),seq(0.74999,0.60,-0.00001),seq(0.59,0.01,-0.01))
...
savePlot(filename="04a_baseline_10percO2",type="png")

#------------------
# save output
#------------------

sens04a <- list(output=list("C"=PP.sens.output,"R"=PP.sens.output.rates),sens=PP.frac,PL=PL)
save(sens04a,file="04a_baseline_10percO2.Rdata")
...
load("04a_baseline_10percO2.Rdata")
...
PP.frac <- c(seq(0.01,0.59,0.01),seq(0.60,0.74999,0.00001),seq(0.75,1,0.01))
...
SV_new <- sens04a$output$C[nrow(sens04a$output$C),]
for (i in 1:length(PP.frac)){
...
savePlot(filename="04b_baseline_10percO2",type="png")

#------------------
# save output
#------------------

sens04b <- list(output=list("C"=PP.sens.output,"R"=PP.sens.output.rates),sens=PP.frac,PL=PL)
save(sens04b,file="04b_baseline_10percO2.Rdata")
...
PP.frac <- c(seq(1,0.05,-0.01),seq(0.0499999,0.02,-0.00001),0.01)
...
savePlot(filename="04a_baseline_1percO2",type="png")
...
sens04a <- list(output=list("C"=PP.sens.output,"R"=PP.sens.output.rates),sens=PP.frac,PL=PL)
save(sens04a,file="04a_baseline_1percO2.Rdata")
...
load("04a_baseline_1percO2.Rdata")
...
PP.frac <- c(0.01,seq(0.02,0.0499999,0.00001),seq(0.05,1,0.01))
...
savePlot(filename="04b_baseline_1percO2",type="png")
...
sens04b <- list(output=list("C"=PP.sens.output,"R"=PP.sens.output.rates),sens=PP.frac,PL=PL)
save(sens04b,file="04b_baseline_1percO2.Rdata")
...
PP_ref    <- 4*1E+18
PL$k_PyFe <- 0
PL$O2_eq  <- sens00$sens[326]

PP.frac <- c(seq(1,0.01,-0.01),seq(0.009999,0.000099,-0.000001))
...
savePlot(filename="04a_baseline_01percO2",type="png")
...
sens04a <- list(output=list("C"=PP.sens.output,"R"=PP.sens.output.rates),sens=PP.frac,PL=PL)
save(sens04a,file="04a_baseline_01percO2.Rdata")
...
load("04a_baseline_01percO2.Rdata")
...
PP.frac <- c(seq(0.01,0.0299999,0.000001),seq(0.04,1,0.01))
...
savePlot(filename="04b_baseline_01percO2",type="png")
...
sens04b <- list(output=list("C"=PP.sens.output,"R"=PP.sens.output.rates),sens=PP.frac,PL=PL)
save(sens04b,file="04b_baseline_01percO2.Rdata")