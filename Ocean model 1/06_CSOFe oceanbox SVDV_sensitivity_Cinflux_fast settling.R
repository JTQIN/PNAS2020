...
load("00_CSOFe_runsteady_fastsettling.Rdata")
...
savePlot(filename="06a_fastsink_10percO2",type="png")
...
save(sens02a,file="06a_fastsink_10percO2.Rdata")
...
load("06a_fastsink_10percO2.Rdata")
...
savePlot(filename="06b_fastsink_10percO2",type="png")
...
save(sens02b,file="06b_fastsink_10percO2.Rdata")
...
savePlot(filename="06a_fastsink_1percO2",type="png")
...
sens02a <- list(output=list("C"=PP.sens.output,"R"=PP.sens.output.rates),sens=PP.frac,PL=PL)
save(sens02a,file="06a_fastsink_1percO2.Rdata")
...
load("06a_fastsink_1percO2.Rdata")
...
savePlot(filename="06b_fastsink_1percO2",type="png")
...
sens02b <- list(output=list("C"=PP.sens.output,"R"=PP.sens.output.rates),sens=PP.frac,PL=PL)
save(sens02b,file="06b_fastsink_1percO2.Rdata")
