...
load("00_CSOFe_runsteady_FFeOOHinc.Rdata")
...
PP.frac <- c(seq(1,0.55,-0.01),seq(0.549999,0.45,-0.00001),seq(0.44,0.01,-0.01))
...
savePlot(filename="08a_FeOOHinc_10percO2",type="png")
...
save(sens02a,file="08a_FeOOHinc_10percO2.Rdata")
...
load("08a_FeOOHinc_10percO2.Rdata")
...
PP.frac <- c(seq(0.01,0.44,0.01),seq(0.45,0.549999,0.00001),seq(0.55,1,0.01))
PP.sens.output       <- NULL
PP.sens.output.rates <- NULL
dy_y                  <- NULL
mass.balance          <- NULL
...
savePlot(filename="08b_FeOOHinc_10percO2",type="png")
...
save(sens02b,file="08b_FeOOHinc_10percO2.Rdata")
...
PP.frac <- c(seq(1,0.09,-0.01),seq(0.0899999,0.05,-0.00001),seq(0.04,0.01,-0.01))
...
savePlot(filename="08a_FeOOHinc_1percO2",type="png")
...
sens02a <- list(output=list("C"=PP.sens.output,"R"=PP.sens.output.rates),sens=PP.frac,PL=PL)
save(sens02a,file="08a_FeOOHinc_1percO2.Rdata")
...
load("08a_FeOOHinc_1percO2.Rdata")
...
PP.frac <- c(seq(0.01,0.04,0.01),seq(0.05,0.0899999,0.00001),seq(0.09,1,0.01))
...
savePlot(filename="08b_FeOOHinc_1percO2",type="png")
...
sens02b <- list(output=list("C"=PP.sens.output,"R"=PP.sens.output.rates),sens=PP.frac,PL=PL)
save(sens02b,file="08b_FeOOHinc_1percO2.Rdata")
