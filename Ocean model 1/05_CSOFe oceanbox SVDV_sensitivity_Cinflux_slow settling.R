...
load("00_CSOFe_runsteady_slowsettling.Rdata")
...
savePlot(filename="05a_slowsink_slowsink_10percO2",type="png")
...
save(sens02a,file="05a_slowsink_slowsink_10percO2.Rdata")
...
load("05a_slowsink_slowsink_10percO2.Rdata")
...
savePlot(filename="05b_slowsink_slowsink_10percO2",type="png")
...
save(sens02b,file="05b_slowsink_slowsink_10percO2.Rdata")
...
savePlot(filename="05a_slowsink_slowsink_1percO2",type="png")
...
sens02a <- list(output=list("C"=PP.sens.output,"R"=PP.sens.output.rates),sens=PP.frac,PL=PL)
save(sens02a,file="05a_slowsink_slowsink_1percO2.Rdata")
...
load("05a_slowsink_slowsink_1percO2.Rdata")
...
savePlot(filename="05b_slowsink_slowsink_1percO2",type="png")
...
sens02b <- list(output=list("C"=PP.sens.output,"R"=PP.sens.output.rates),sens=PP.frac,PL=PL)
save(sens02b,file="05b_slowsink_slowsink_1percO2.Rdata")
